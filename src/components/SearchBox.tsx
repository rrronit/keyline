...
export const SearchBox = ({
	...
	return (
		<div className="relative">
			<div className="flex items-center px-3 py-4 border-b border-zinc-800/50 bg-gradient-to-r from-zinc-900/50 via-zinc-800/50 to-zinc-900/50">
				<motion.div
				...
				<AnimatePresence>
					{query && (
						<motion.div
							...
							transition={{ duration: 0.2 }}
							className="ml-4 px-2 py-1 bg-zinc-800/50 rounded-md text-xs text-zinc-400 border border-zinc-700/50"
						>
			...
			<AnimatePresence>
				{query && (
					<motion.div
						...
						className="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-blue-500/50 to-transparent origin-center"
					/>
				)}
			</AnimatePresence>
		</div>
